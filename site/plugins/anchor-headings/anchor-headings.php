...
function headingAnchors($field, $returntoc = false)
{
  ...
  // Insert anchors and generate toc
  $toc = insertAnchors($options);

  if ($returntoc) return $toc;
...
field::$methods['toc'] = function ($field) {
  return headingAnchors($field, true);
};
